...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < ArraysForStart.P_Kazdogo_Priemnika.length; i++) {
            System.out.println("Мощность группы электроприемников №" + (i + 1) +
                    ": " + ArraysForStart.Q_sm_Vseh_Priemnikov[i] + " кВт ");
        }
